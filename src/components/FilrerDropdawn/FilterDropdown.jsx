...
const FilterDropdown =({onChange}) => {
    ...
    return (
        <div className={styles.filterWrapper}>
            ...
            <select className={styles.select} value={selectedFilter} onChange={handleFilterChange}>
                <option className={styles.optionName} value="show all">Show All</option>
                <option className={styles.optionName} value="follow">Follow</option>
                <option className={styles.optionName} value="followings">Followings</option>
            </select>
        </div>
    );
}
